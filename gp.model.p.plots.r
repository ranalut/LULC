...
var.names <- c(paste('X',c(0,1,2,6:17),sep=''),'hours')
boxplot.table <- data.frame(conus=c(conus.names[-c(3:5)],'hours'),var=var.names)

# for (i in 1:length(spp$BBL_ABBREV)) # max is 22
# modifier <- 'raptors'; for (i in c(8,9,13,14,16,17,18,22))
